CREATE TABLE `depaby_contacts` (
    ...
    `depaby_phone1_format` VARCHAR(24) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
    `depaby_phone1_noformat` VARCHAR(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
    `depaby_phone2_format` VARCHAR(24) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
    `depaby_phone2_noformat` VARCHAR(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
